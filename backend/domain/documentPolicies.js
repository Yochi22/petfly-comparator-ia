...
const POLICIES = Object.freeze({
  ...
  REVISION: { requiredChecks: ['CERTIFICATION_DATE', 'EXPIRY_DATE', 'CERTIFICATE_NUMBER_INTERNAL_CONSISTENCY'] },
  INFORME_ENTRENAMIENTO: {
    requiredChecks: [
      'OWNER_IDENTITY',
      'DOG_DATA',
      'DOG_NAME_CONSISTENCY',
      'DIAGNOSIS_INTERNAL_CONSISTENCY',
      'DATES',
      'GRAMMAR',
    ],
  },
  ADI: { requiredChecks: ['OWNER_IDENTITY', 'DOG_NAME', 'DOG_BREED', 'ISSUE_DATE', 'PHONE_COUNTRY', 'CERTIFICATE_NUMBER_INTERNAL_CONSISTENCY', 'QR_CERTIFICATE_NUMBER', 'GRAMMAR'] },
  K9: { requiredChecks: ['OWNER_IDENTITY', 'DOG_NAME', 'DOG_BREED', 'GRAMMAR'] },
  CERTIFICACION_ADI: { requiredChecks: ['OWNER_NAME', 'DOG_NAME', 'DOG_BREED', 'ISSUE_DATE', 'TRAINING_160_HOURS', 'CERTIFICATE_NUMBER_INTERNAL_CONSISTENCY', 'GRAMMAR'] },
  MEDICAL_HISTORY_TRANSLATE: {
    requiredChecks: ['OWNER_NAME', 'OWNER_ID', 'DATE', 'ENGLISH_GRAMMAR', 'PATIENT_WEIGHT_CONSISTENCY', 'PATIENT_HEIGHT_CONSISTENCY'],
  },
