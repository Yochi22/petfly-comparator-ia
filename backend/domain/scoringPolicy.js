...
const CRITICAL_CHECKS = new Set([
  ...
  'DIAGNOSIS_INTERNAL_CONSISTENCY', 'CERTIFICATE_NUMBER_INTERNAL_CONSISTENCY',
  'QR_CERTIFICATE_NUMBER', 'CERTIFICATE_NUMBER_CROSS_DOCUMENT',
  'PATIENT_WEIGHT_CONSISTENCY', 'PATIENT_HEIGHT_CONSISTENCY',
]);
...
const CHECK_ALIASES = Object.freeze({
  ...
  DIAGNOSIS_INTERNAL_CONSISTENCY: ['DIAGNOSIS_INTERNAL_CONSISTENCY', 'DIAGNOSIS_CONSISTENCY'],
  CERTIFICATE_NUMBER_INTERNAL_CONSISTENCY: ['CERTIFICATE_NUMBER_INTERNAL_CONSISTENCY', 'CERTIFICATE_NUMBER', 'REGISTRATION_NUMBER'],
  QR_CERTIFICATE_NUMBER: ['QR_CERTIFICATE_NUMBER'],
});
